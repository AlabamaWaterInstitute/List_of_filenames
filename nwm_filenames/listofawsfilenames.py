...
def operational_archive_file_name_creator(dates, runinput, varinput, geoinput, run_name, meminput,urlbaseinput ,fcst_cycle,lead_time, r):
    ...
    if runinput == 1:  # if short_range
        ...
        if varinput == 1:
            ...
            raise ValueError(
                "only valid variable for a _no_da type run is channel_rt"
            )
...
def retrospective_archive_file_name_creator(start_date, end_date, objecttype, file_types, urlbase_prefix, r):
...
def create_file_list(
    ...
    if urlbaseinput != 6:
        ...
        operational_archive_file_name_creator(dates, runinput, varinput, geoinput, run_name, meminput,urlbaseinput, fcst_cycle, lead_time, r)

    elif urlbaseinput == 6:
        retrospective_archive_file_name_creator(start_date, end_date, objecttype, file_types, urlbase_prefix, r)

    return r, len(r)

def test_create_file_list():
    # Test
    result, length = create_file_list(2, 1, 1, 1, '197902010000', '197902020800',[12, 18], 6, [1, 2, 240], [5,6], 1)
    assert isinstance(result, list)
    assert isinstance(length, int)
    assert len(result) == length
    expected_urls = ['https://noaa-nwm-retrospective-2-1-pds.s3.amazonaws.com/forcing/1979/197902010000.LDASIN_DOMAIN1', 'https://noaa-nwm-retrospective-2-1-pds.s3.amazonaws.com/forcing/1979/197902010100.LDASIN_DOMAIN1',
                     'https://noaa-nwm-retrospective-2-1-pds.s3.amazonaws.com/forcing/1979/197902010200.LDASIN_DOMAIN1', 'https://noaa-nwm-retrospective-2-1-pds.s3.amazonaws.com/forcing/1979/197902010300.LDASIN_DOMAIN1',
                     'https://noaa-nwm-retrospective-2-1-pds.s3.amazonaws.com/forcing/1979/197902010400.LDASIN_DOMAIN1', 'https://noaa-nwm-retrospective-2-1-pds.s3.amazonaws.com/forcing/1979/197902010500.LDASIN_DOMAIN1',
                     'https://noaa-nwm-retrospective-2-1-pds.s3.amazonaws.com/forcing/1979/197902010600.LDASIN_DOMAIN1', 'https://noaa-nwm-retrospective-2-1-pds.s3.amazonaws.com/forcing/1979/197902010700.LDASIN_DOMAIN1',
                     'https://noaa-nwm-retrospective-2-1-pds.s3.amazonaws.com/forcing/1979/197902010800.LDASIN_DOMAIN1', 'https://noaa-nwm-retrospective-2-1-pds.s3.amazonaws.com/forcing/1979/197902010900.LDASIN_DOMAIN1',
                     'https://noaa-nwm-retrospective-2-1-pds.s3.amazonaws.com/forcing/1979/197902011000.LDASIN_DOMAIN1', 'https://noaa-nwm-retrospective-2-1-pds.s3.amazonaws.com/forcing/1979/197902011100.LDASIN_DOMAIN1',
                     'https://noaa-nwm-retrospective-2-1-pds.s3.amazonaws.com/forcing/1979/197902011200.LDASIN_DOMAIN1', 'https://noaa-nwm-retrospective-2-1-pds.s3.amazonaws.com/forcing/1979/197902011300.LDASIN_DOMAIN1',
                     'https://noaa-nwm-retrospective-2-1-pds.s3.amazonaws.com/forcing/1979/197902011400.LDASIN_DOMAIN1', 'https://noaa-nwm-retrospective-2-1-pds.s3.amazonaws.com/forcing/1979/197902011500.LDASIN_DOMAIN1',
                     'https://noaa-nwm-retrospective-2-1-pds.s3.amazonaws.com/forcing/1979/197902011600.LDASIN_DOMAIN1', 'https://noaa-nwm-retrospective-2-1-pds.s3.amazonaws.com/forcing/1979/197902011700.LDASIN_DOMAIN1',
                     'https://noaa-nwm-retrospective-2-1-pds.s3.amazonaws.com/forcing/1979/197902011800.LDASIN_DOMAIN1', 'https://noaa-nwm-retrospective-2-1-pds.s3.amazonaws.com/forcing/1979/197902011900.LDASIN_DOMAIN1',
                     'https://noaa-nwm-retrospective-2-1-pds.s3.amazonaws.com/forcing/1979/197902012000.LDASIN_DOMAIN1', 'https://noaa-nwm-retrospective-2-1-pds.s3.amazonaws.com/forcing/1979/197902012100.LDASIN_DOMAIN1',
                     'https://noaa-nwm-retrospective-2-1-pds.s3.amazonaws.com/forcing/1979/197902012200.LDASIN_DOMAIN1', 'https://noaa-nwm-retrospective-2-1-pds.s3.amazonaws.com/forcing/1979/197902012300.LDASIN_DOMAIN1',
                     'https://noaa-nwm-retrospective-2-1-pds.s3.amazonaws.com/forcing/1979/197902020000.LDASIN_DOMAIN1', 'https://noaa-nwm-retrospective-2-1-pds.s3.amazonaws.com/forcing/1979/197902020100.LDASIN_DOMAIN1',
                     'https://noaa-nwm-retrospective-2-1-pds.s3.amazonaws.com/forcing/1979/197902020200.LDASIN_DOMAIN1', 'https://noaa-nwm-retrospective-2-1-pds.s3.amazonaws.com/forcing/1979/197902020300.LDASIN_DOMAIN1',
                     'https://noaa-nwm-retrospective-2-1-pds.s3.amazonaws.com/forcing/1979/197902020400.LDASIN_DOMAIN1', 'https://noaa-nwm-retrospective-2-1-pds.s3.amazonaws.com/forcing/1979/197902020500.LDASIN_DOMAIN1',
                     'https://noaa-nwm-retrospective-2-1-pds.s3.amazonaws.com/forcing/1979/197902020600.LDASIN_DOMAIN1', 'https://noaa-nwm-retrospective-2-1-pds.s3.amazonaws.com/forcing/1979/197902020700.LDASIN_DOMAIN1',
